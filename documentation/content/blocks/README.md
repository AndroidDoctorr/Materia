...
This section documents Materia blocks. Each block page should include:

- **What it is / why it exists**
- **How to obtain / craft**
- **Key interactions** (mechanics, right-click behavior, fluids, heat, etc.)
- **Related**: items/blocks + recipe JSON links

## Categories

- **Natural**: generated / found blocks (ores, trees, soils, etc.)
- **Craftable**: player-made blocks (pots, stations, machines)
- **By “era”** (optional): Stone / Bronze / Iron / etc.

## Examples

- [Amphora (example page)](amphora.md)
- [Anvils (overview)](anvils.md)
- [Stone anvil](stone-anvil.md)
- [Bronze anvil](bronze-anvil.md)
- [Iron anvil](iron-anvil.md)
- [Cannon](cannon.md)
- [Gunpowder trail](gunpowder-trail.md)
...
- [Coke oven](coke-oven.md)
- [Oven](oven.md)
- [Fire pit](fire-pit.md)
- [Drying rack](drying-rack.md)
- [Profession blocks (recipe overrides)](profession-blocks.md)
- [Logic blocks](logic.md)
- [Oil lamp](oil-lamp.md)
- [Wood components](wood.md)
- [Earth](earth.md)
- [Tin gravel](gravel-tin.md)
- [Malachite](malachite.md)
- [Olive tree](olive-tree.md)
- [Rubber tree](rubber-tree.md)
- [Tapped rubber tree log](tapped-rubber-tree-log.md)
- [Primitive crafting table](primitive-crafting-table.md)
- [Rock](rock.md)
...
- [Wrought iron fence, gate & door](wrought-iron-building.md)
