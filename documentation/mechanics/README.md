...
Use this section to document “systems” that affect multiple items/blocks/recipes.
...
- [Cannons](cannons.md)
- [Gunpowder trails](gunpowder-trails.md)
- [Instruments](instruments.md)
- [Hot metals](hot-metals.md)
- [Kilns](kilns.md)
- [Anvils](anvils.md)
- [Metalworking (bronze and beyond)](metalworking.md)
- [Water pot](water-pot.md)
- [Leatherworking (tanning + hardening)](leatherworking.md)
...
- [Power components (battery, dynamo, solenoid, wires)](power-components.md)
- [Crops and farming](crops.md)
- [Food (overview)](food.md)

## Suggested page list (create as you need them)
