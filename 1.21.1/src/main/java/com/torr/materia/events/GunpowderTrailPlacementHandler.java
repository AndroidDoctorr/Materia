...
public class GunpowderTrailPlacementHandler {
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        // 1.20+ doesn't expose Material-based replaceability checks here; use block placement context instead
        BlockHitResult placeHit = new BlockHitResult(Vec3.atCenterOf(placePos), event.getFace(), placePos, false);
        BlockPlaceContext placeContext = new BlockPlaceContext(player, event.getHand(), stack, placeHit);
