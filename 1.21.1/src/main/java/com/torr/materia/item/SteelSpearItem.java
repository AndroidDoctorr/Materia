...
public class SteelSpearItem extends SwordItem {
    ...
    public SteelSpearItem(Properties properties) {
        // Diamond tier, highest damage modifier (5), same swing speed
        super(Tiers.DIAMOND, properties.attributes(SwordItem.createAttributes(Tiers.DIAMOND, 5, -1.8F)));
    }
