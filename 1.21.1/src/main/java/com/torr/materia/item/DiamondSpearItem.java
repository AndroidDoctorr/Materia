...
public class DiamondSpearItem extends SwordItem {
    ...
    public DiamondSpearItem(Properties properties) {
        // Diamond tier, same damage as steel spear but faster handling
        super(Tiers.DIAMOND, properties.attributes(SwordItem.createAttributes(Tiers.DIAMOND, 5, -1.6F)));
    }
