...
public class NetheriteSpearItem extends SwordItem {
    ...
    public NetheriteSpearItem(Properties properties) {
        // Netherite tier, improved damage (vs diamond/steel) at a slightly slower speed
        super(Tiers.NETHERITE, properties.attributes(SwordItem.createAttributes(Tiers.NETHERITE, 5, -1.7F)));
    }
