...
public class IronSpearItem extends SwordItem {
    ...
    public IronSpearItem(Properties properties) {
        // Iron tier, higher damage modifier (4), same swing speed
        super(Tiers.IRON, properties.attributes(SwordItem.createAttributes(Tiers.IRON, 4, -1.8F)));
    }
