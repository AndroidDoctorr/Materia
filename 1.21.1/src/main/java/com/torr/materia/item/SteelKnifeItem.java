...
public class SteelKnifeItem extends SwordItem {
    ...
    public SteelKnifeItem(Properties properties) {
        // Steel-tier knife: best damage and fastest speed
        super(Tiers.DIAMOND, properties.attributes(SwordItem.createAttributes(Tiers.DIAMOND, 4, -1.4F)));
    }
