...
public class ClientSetup {
    ...
    public static void clientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.RAINBOW_EUCALYPTUS_LEAVES.get(), RenderType.cutoutMipped());
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.TEAL_GLASS.get(), RenderType.translucent());
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.CHERRY_TRELLIS.get(), RenderType.cutout());
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.CHERRY_POST.get(), RenderType.cutout());
