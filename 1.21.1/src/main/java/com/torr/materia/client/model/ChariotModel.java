...
public class ChariotModel extends EntityModel<ChariotEntity> {
    ...
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(materia.MOD_ID, "chariot"), "main");
    ...
    private static final float FLOOR_H = 0;
    ...
    private static final Set<Direction> FRONT_FACE = EnumSet.of(Direction.NORTH);
    private static final Set<Direction> RIGHT_FACE = EnumSet.of(Direction.EAST);
    private static final Set<Direction> LEFT_FACE = EnumSet.of(Direction.WEST);
    private static final Set<Direction> FLOOR_FACE = EnumSet.of(Direction.UP);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(16, 16)
                        .addBox(-HALF_W, BODY_BASE, -HALF_L, W, FLOOR_H, L, FLOOR_FACE),
                PartPose.ZERO);
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(16, 0)
                        .addBox(-HALF_W, BODY_BASE + FLOOR_H, -HALF_L, W, WALL_H, WALL_T, FRONT_FACE),
                PartPose.ZERO);
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(HALF_W - WALL_T, BODY_BASE + FLOOR_H, -HALF_L, WALL_T, WALL_H, L, RIGHT_FACE),
                PartPose.ZERO);
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(32, 0)
                        .addBox(-HALF_W, BODY_BASE + FLOOR_H, -HALF_L, WALL_T, WALL_H, L, LEFT_FACE),
                PartPose.ZERO);
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(15, 0)
                        .addBox(0.0F - 3.0F, BODY_BASE + FLOOR_H, -1.5F*L, 6.0F, 0.0F, 16.0F, FLOOR_FACE),
                PartPose.ZERO);
