...
public class FirePitScreen extends AbstractContainerScreen<FirePitMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(materia.MOD_ID, "textures/gui/fire_pit.png");

    public FirePitScreen(FirePitMenu menu, Inventory inventory, Component component) {
