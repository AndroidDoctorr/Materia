...
public class ConditionalTranslationManager {
    ...
    public void loadFlemishTranslations() {
        ...
        try {
            ...
            ResourceLocation flemishLangFile = ResourceLocation.fromNamespaceAndPath(materia.MOD_ID, "lang/nl_be.json");
            
            try {
                Optional<Resource> resourceOpt = resourceManager.getResource(flemishLangFile);
