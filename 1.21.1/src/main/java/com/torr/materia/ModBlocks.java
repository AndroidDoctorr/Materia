...
public class ModBlocks {
        ...
        public static final RegistryObject<Block> MARBLE_STAIRS = registerBlock("marble_stairs",
                        () -> new net.minecraft.world.level.block.StairBlock(
                                ...
                                BlockBehaviour.Properties.ofFullCopy(ModBlocks.MARBLE.get())));
        ...
        public static final RegistryObject<Block> LIMESTONE_STAIRS = registerBlock("limestone_stairs",
                        () -> new net.minecraft.world.level.block.StairBlock(
                                ...
                                BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIMESTONE.get())));
        ...
        public static final RegistryObject<Block> TEAL_BED = BLOCKS.register("teal_bed",
                        () -> new BedBlock(DyeColor.CYAN, BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_BED)));
        ...
        public static final RegistryObject<Block> YUCCA = registerBlock("yucca",
                        () -> new YuccaBlock(BlockBehaviour.Properties.of().noCollission().instabreak()
                                        .sound(SoundType.GRASS)));
        public static final RegistryObject<Block> PLANTAIN = registerBlock("plantain",
                        () -> new PlantainBlock(BlockBehaviour.Properties.of().noCollission().instabreak()
                                        .sound(SoundType.GRASS)));
        public static final RegistryObject<Block> REEDS = registerBlock("reeds",
                        () -> new ReedsBlock(BlockBehaviour.Properties.of().noCollission().instabreak()
                                        .sound(SoundType.GRASS)));
        public static final RegistryObject<Block> WHITE_LILY = registerBlock("white_lily",
                        () -> new WhiteLilyBlock(BlockBehaviour.Properties.of().noCollission().instabreak()
                                        .sound(SoundType.GRASS)));
        public static final RegistryObject<Block> BLUEBONNET = registerBlock("bluebonnet",
                        () -> new BluebonnetBlock(BlockBehaviour.Properties.of().noCollission().instabreak()
                                        .sound(SoundType.GRASS)));
        ...
        public static final RegistryObject<Block> TEAL_GLASS = registerBlock("teal_glass",
                        () -> new net.minecraft.world.level.block.StainedGlassBlock(DyeColor.CYAN, BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS).noOcclusion()));
        ...
        public static final RegistryObject<Block> TEAL_CANDLE = registerBlock("teal_candle",
                        () -> new net.minecraft.world.level.block.CandleBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_CANDLE)));
        ...
        public static final RegistryObject<Block> WROUGHT_IRON_FENCE = registerBlock("wrought_iron_fence",
                        () -> new com.torr.materia.block.WroughtIronFenceBlock(
                                BlockBehaviour.Properties.ofFullCopy(ModBlocks.WROUGHT_IRON_BLOCK.get()).noOcclusion()));
        ...
        public static final RegistryObject<Block> WROUGHT_IRON_DOOR = registerBlock("wrought_iron_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                ModBlockSetTypes.WROUGHT_IRON,
                                BlockBehaviour.Properties.ofFullCopy(ModBlocks.WROUGHT_IRON_BLOCK.get()).strength(5.0F).noOcclusion()));
        ...
        public static final RegistryObject<Block> FIG_LEAVES = registerBlock("fig_leaves",
                        () -> new com.torr.materia.block.FigTreeLeavesBlock(BlockBehaviour.Properties.of().strength(0.2f).randomTicks().sound(SoundType.GRASS).noOcclusion().isValidSpawn((state, world, pos, type) -> false).isSuffocating((state, world, pos) -> false).isViewBlocking((state, world, pos) -> false)));
        ...
        public static final RegistryObject<Block> CEDAR_SAPLING = registerBlock("cedar_sapling",
                        () -> new com.torr.materia.block.CedarSaplingBlock(BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));
        public static final RegistryObject<Block> CEDAR_LEAVES = registerBlock("cedar_leaves",
                        () -> new com.torr.materia.block.CedarLeavesBlock(BlockBehaviour.Properties.of().strength(0.2f).randomTicks().sound(SoundType.GRASS).noOcclusion().isValidSpawn((state, world, pos, type) -> false).isSuffocating((state, world, pos) -> false).isViewBlocking((state, world, pos) -> false)));
        ...
        public static final RegistryObject<Block> RAINBOW_EUCALYPTUS_SAPLING = registerBlock("rainbow_eucalyptus_sapling",
                        () -> new com.torr.materia.block.RainbowEucalyptusSaplingBlock(BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));
        ...
        private static BlockBehaviour.Properties rugProps() {
                return BlockBehaviour.Properties.of().strength(0.1F).sound(SoundType.WOOL).noOcclusion();
        }
