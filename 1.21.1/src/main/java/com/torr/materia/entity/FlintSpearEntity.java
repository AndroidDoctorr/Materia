...
public class FlintSpearEntity extends AbstractArrow implements ItemSupplier {
    ...
    public FlintSpearEntity(Level level, LivingEntity owner, ItemStack stack) {
        super(ModEntities.FLINT_SPEAR_PROJECTILE.get(), owner, level, stack.copy(), stack.copy());
    ...
    public void addAdditionalSaveData(CompoundTag tag) {
        ...
        tag.put("Spear", spearItem.save(this.level().registryAccess(), new CompoundTag()));
    }
    ...
    public void readAdditionalSaveData(CompoundTag tag) {
        ...
        if (tag.contains("Spear")) {
            spearItem = ItemStack.parseOptional(this.level().registryAccess(), tag.getCompound("Spear"));
            if (spearItem.isEmpty()) {
                spearItem = new ItemStack(ModItems.FLINT_SPEAR.get());
            }
        }
    }
