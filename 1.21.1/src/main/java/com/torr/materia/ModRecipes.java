...
import com.torr.materia.recipe.BoneStripRecipe;
...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<FlintKnifeRecipe>> FLINT_KNIFE_SERIALIZER =
            RECIPE_SERIALIZERS.register("crafting_flint_knife", () -> new SimpleCraftingRecipeSerializer<>(FlintKnifeRecipe::new));

    public static final RegistryObject<RecipeSerializer<FlintSpearRecipe>> FLINT_SPEAR_SERIALIZER =
            RECIPE_SERIALIZERS.register("crafting_flint_spear", () -> new SimpleCraftingRecipeSerializer<>(FlintSpearRecipe::new));

    public static final RegistryObject<RecipeSerializer<PrimitiveCraftingTableRecipe>> PRIMITIVE_CRAFTING_TABLE_SERIALIZER =
            RECIPE_SERIALIZERS.register("crafting_primitive_crafting_table", () -> new SimpleCraftingRecipeSerializer<>(PrimitiveCraftingTableRecipe::new));

    public static final RegistryObject<RecipeSerializer<LeatherArmorDyeRecipe>> LEATHER_ARMOR_DYE_SERIALIZER =
            RECIPE_SERIALIZERS.register("crafting_leather_armor_dyeing", () -> new SimpleCraftingRecipeSerializer<>(LeatherArmorDyeRecipe::new));
    ...
    public static final RegistryObject<RecipeSerializer<BoneStripRecipe>> BONE_STRIP_SERIALIZER =
            RECIPE_SERIALIZERS.register("bone_strip", () -> new SimpleCraftingRecipeSerializer<>(BoneStripRecipe::new));
    ...
    public static final RegistryObject<RecipeSerializer<RugBaseRecipe>> RUG_BASE_SERIALIZER =
            RECIPE_SERIALIZERS.register("rug_base", () -> new SimpleCraftingRecipeSerializer<>(RugBaseRecipe::new));
