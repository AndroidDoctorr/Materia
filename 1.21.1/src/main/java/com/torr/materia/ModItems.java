...
public class ModItems {
        ...
        public static final RegistryObject<Item> ROUGH_CHERRY_PLANK = ITEMS.register("rough_cherry_plank",
                        () -> new Item(new Item.Properties()
                                        ));
        ...
        public static final RegistryObject<Item> BRONZE_HELMET = ITEMS.register("bronze_helmet",
                        () -> new com.torr.materia.item.BronzeArmorItem(
                                        com.torr.materia.item.ModArmorMaterials.bronzeHolder(),
                                        net.minecraft.world.item.ArmorItem.Type.HELMET,
                                        new Item.Properties()
                                                        .durability(net.minecraft.world.item.ArmorItem.Type.HELMET
                                                                .getDurability(com.torr.materia.item.ModArmorMaterials.BRONZE_DURABILITY_MULTIPLIER))));
        ...
        public static final RegistryObject<Item> IRON_HELMET = ITEMS.register("iron_helmet",
                        () -> new com.torr.materia.item.IronArmorItem(
                                        com.torr.materia.item.ModArmorMaterials.wroughtIronHolder(),
                                        net.minecraft.world.item.ArmorItem.Type.HELMET,
                                        new Item.Properties()
                                                        .durability(net.minecraft.world.item.ArmorItem.Type.HELMET
                                                                .getDurability(com.torr.materia.item.ModArmorMaterials.WROUGHT_IRON_DURABILITY_MULTIPLIER))));
