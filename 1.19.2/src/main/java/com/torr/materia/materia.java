...
public class materia
{
    ...
    public materia()
    {
        ...
        ModRecipes.RECIPE_TYPES.register(FMLJavaModLoadingContext.get().getModEventBus());
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        LOGGER.info("DIRT BLOCK >> {}", net.minecraft.core.Registry.BLOCK.getKey(Blocks.DIRT));
        ...
        event.enqueueWork(() -> {
            ...
            try {
                addValidBlocksToBedType(
                        ...
                        ModBlocks.BURGUNDY_BED.get(),
                        ModBlocks.TAN_BED.get()
                );
            } catch (Exception e) {
