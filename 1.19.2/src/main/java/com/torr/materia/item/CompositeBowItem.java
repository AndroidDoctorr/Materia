...
public class CompositeBowItem extends BowItem {
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity entity, int timeLeft) {
        if (entity instanceof Player) {
            ...
            boolean hasAmmo = player.getAbilities().instabuild || EnchantmentHelper.getItemEnchantmentLevel(Enchantments.INFINITY_ARROWS, stack) > 0;
            ...
            if (!ammo.isEmpty() || hasAmmo) {
                ...
                if (!((double) power < 0.1D)) {
                    ...
                    if (!level.isClientSide) {
                        ...
                        int powerEnchantLevel = EnchantmentHelper.getItemEnchantmentLevel(Enchantments.POWER_ARROWS, stack);
