...
public class ModBlocks {
        ...
        public static final RegistryObject<Block> SALT_BLOCK = registerBlock("salt_block",
                        () -> new Block(BlockBehaviour.Properties.of(Material.SAND).strength(0.5f)
                                        .sound(SoundType.SAND)));
        ...
        public static final RegistryObject<Block> FORGE = registerBlock("forge",
                        () -> new com.torr.materia.block.ForgeBlock(BlockBehaviour.Properties.of(Material.STONE).strength(1.5f)
                                        .sound(SoundType.STONE).noOcclusion()
                                        .lightLevel(state -> 13)));
        ...
        public static final RegistryObject<Block> FRESH_CHEESE_WHEEL = registerBlock("fresh_cheese_wheel",
                        () -> new FreshCheeseWheelBlock(BlockBehaviour.Properties.of(Material.CAKE).strength(0.4f)
                                        .sound(SoundType.WOOL)
                                        .noOcclusion()));
        public static final RegistryObject<Block> AGED_CHEESE_WHEEL = registerBlock("aged_cheese_wheel",
                        () -> new CheeseWheelBlock(BlockBehaviour.Properties.of(Material.CAKE).strength(0.6f)
                                        .sound(SoundType.WOOL)
                                        .noOcclusion()));
        ...
        public static final RegistryObject<Block> ROOF_TILES = registerBlockWithCustomItem("roof_tiles",
                        () -> new com.torr.materia.block.RoofTilesBlock(
                                BlockBehaviour.Properties.of(net.minecraft.world.level.material.Material.STONE)
                                        .strength(0.8f)
                                        .sound(SoundType.STONE)
                                        .noOcclusion()),
        ...
        public static final RegistryObject<Block> RUBBER_WOOD_DOOR = registerBlock("rubber_wood_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.RUBBER_WOOD_PLANKS.get()).strength(3.0F).noOcclusion()));
        ...
        public static final RegistryObject<Block> MAPLE_SAPLING = registerBlock("maple_sapling",
                        () -> new com.torr.materia.block.MapleSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT)
                                        .noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));
        public static final RegistryObject<Block> MAPLE_LEAVES = registerBlock("maple_leaves",
                        () -> new com.torr.materia.block.MapleLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES)
                                        .strength(0.2f).randomTicks().sound(SoundType.GRASS).noOcclusion()
                                        .isValidSpawn((state, world, pos, type) -> false)
                                        .isSuffocating((state, world, pos) -> false)
                                        .isViewBlocking((state, world, pos) -> false)));
        ...
        public static final RegistryObject<Block> EUCALYPTUS_LEAVES = registerBlock("eucalyptus_leaves",
                        () -> new com.torr.materia.block.EucalyptusLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).randomTicks().sound(SoundType.GRASS).noOcclusion().isValidSpawn((state, world, pos, type) -> false).isSuffocating((state, world, pos) -> false).isViewBlocking((state, world, pos) -> false)));
        public static final RegistryObject<Block> RAINBOW_EUCALYPTUS_LEAVES = registerBlock("rainbow_eucalyptus_leaves",
                        () -> new com.torr.materia.block.RainbowEucalyptusLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).randomTicks().sound(SoundType.GRASS).noOcclusion().isValidSpawn((state, world, pos, type) -> false).isSuffocating((state, world, pos) -> false).isViewBlocking((state, world, pos) -> false)));
        ...
        public static final RegistryObject<Block> FIG_DOOR = registerBlock("fig_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.FIG_PLANKS.get()).strength(3.0F).noOcclusion()));
        ...
        public static final RegistryObject<Block> CEDAR_DOOR = registerBlock("cedar_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.CEDAR_PLANKS.get()).strength(3.0F).noOcclusion()));
        ...
        public static final RegistryObject<Block> EUCALYPTUS_DOOR = registerBlock("eucalyptus_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.EUCALYPTUS_PLANKS.get()).strength(3.0F).noOcclusion()));
