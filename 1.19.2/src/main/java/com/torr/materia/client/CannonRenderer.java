...
public class CannonRenderer implements BlockEntityRenderer<CannonBlockEntity> {
    ...
    // 1.19.x: the barrel model's "forward" ends up flipped relative to the world-yaw convention used by firing math.
    // Compensate in rendering only (do NOT change firing direction).
