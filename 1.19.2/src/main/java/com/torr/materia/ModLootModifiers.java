...
public class ModLootModifiers {
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> ANIMAL_DROP_MODIFIER =
            GLM_SERIALIZERS.register("animal_drop_modifier", () -> AnimalDropModifier.CODEC);
    
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> SHEEP_WOOL_MODIFIER =
            GLM_SERIALIZERS.register("sheep_wool_modifier", () -> SheepWoolModifier.CODEC);

    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> LEAF_FIBER_MODIFIER =
            GLM_SERIALIZERS.register("leaf_fiber_modifier", () -> LeafFiberModifier.CODEC);

    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> GRASS_FIBER_MODIFIER =
