...
public class RugPatternItem extends BannerPatternItem {
    public static final TagKey<BannerPattern> RUG_1_TAG =
            TagKey.create(Registries.BANNER_PATTERN, new ResourceLocation(materia.MOD_ID, "rug_1"));
    public static final TagKey<BannerPattern> RUG_2_TAG =
            TagKey.create(Registries.BANNER_PATTERN, new ResourceLocation(materia.MOD_ID, "rug_2"));
    public static final TagKey<BannerPattern> RUG_3_TAG =
            TagKey.create(Registries.BANNER_PATTERN, new ResourceLocation(materia.MOD_ID, "rug_3"));
    public static final TagKey<BannerPattern> RUG_4_TAG =
            TagKey.create(Registries.BANNER_PATTERN, new ResourceLocation(materia.MOD_ID, "rug_4"));
