...
public class UrnBlock extends BaseEntityBlock {
    ...
    public InteractionResult use(BlockState state, Level level, BlockPos pos, Player player,
        ...
        if (stack.isEmpty()) {
            ...
            urn.setPlant(net.minecraft.world.level.block.Blocks.AIR);
        ...
        if (urn.getPlant() != net.minecraft.world.level.block.Blocks.AIR) {
            return InteractionResult.PASS;
        }
    ...
    public void onRemove(BlockState state, Level level, BlockPos pos, BlockState newState, boolean isMoving) {
        if (!state.is(newState.getBlock())) {
            BlockEntity blockEntity = level.getBlockEntity(pos);
            if (blockEntity instanceof UrnBlockEntity urn && urn.getPlant() != net.minecraft.world.level.block.Blocks.AIR) {
