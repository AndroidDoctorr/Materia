...
public class ModBlocks {
        ...
        public static final RegistryObject<Block> GRAVEL_TIN = registerBlock("gravel_tin",
                        () -> new FallingBlock(BlockBehaviour.Properties.of().strength(0.6f)
        ...
        public static final RegistryObject<Block> SALTPETER_SAND = registerBlock("saltpeter_sand",
                        () -> new FallingBlock(BlockBehaviour.Properties.of().strength(0.5f)
        ...
        public static final RegistryObject<Block> RUBBER_WOOD_DOOR = registerBlock("rubber_wood_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.RUBBER_WOOD_PLANKS.get()).strength(3.0F).noOcclusion().ignitedByLava(),
        ...
        public static final RegistryObject<Block> FIG_SAPLING = registerBlock("fig_sapling",
                        () -> new com.torr.materia.block.FigTreeSaplingBlock(BlockBehaviour.Properties.of()
                                        .noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));
        public static final RegistryObject<Block> FIG_LEAVES = registerBlock("fig_leaves",
                        () -> new com.torr.materia.block.FigTreeLeavesBlock(BlockBehaviour.Properties.of()
                                        .strength(0.2f).randomTicks().sound(SoundType.GRASS).noOcclusion()
                                        .isValidSpawn((state, world, pos, type) -> false)
                                        .isSuffocating((state, world, pos) -> false)
                                        .isViewBlocking((state, world, pos) -> false)));
        ...
        public static final RegistryObject<Block> CEDAR_SAPLING = registerBlock("cedar_sapling",
                        () -> new com.torr.materia.block.CedarSaplingBlock(BlockBehaviour.Properties.of()
                                        .noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));
        ...
        public static final RegistryObject<Block> RAINBOW_EUCALYPTUS_SAPLING = registerBlock("rainbow_eucalyptus_sapling",
                        () -> new com.torr.materia.block.RainbowEucalyptusSaplingBlock(BlockBehaviour.Properties.of()
                                        .noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));
        ...
        public static final RegistryObject<Block> FIG_DOOR = registerBlock("fig_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.FIG_PLANKS.get()).strength(3.0F).noOcclusion().ignitedByLava(),
        ...
        public static final RegistryObject<Block> CEDAR_DOOR = registerBlock("cedar_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.CEDAR_PLANKS.get()).strength(3.0F).noOcclusion().ignitedByLava(),
        ...
        public static final RegistryObject<Block> EUCALYPTUS_DOOR = registerBlock("eucalyptus_door",
                        () -> new net.minecraft.world.level.block.DoorBlock(
                                BlockBehaviour.Properties.copy(ModBlocks.EUCALYPTUS_PLANKS.get()).strength(3.0F).noOcclusion().ignitedByLava(),
