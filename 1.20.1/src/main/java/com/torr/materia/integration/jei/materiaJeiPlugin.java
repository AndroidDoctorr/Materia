...
public class materiaJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<FirePitRecipe> firePit = recipeManager.getAllRecipesFor(ModRecipes.FIRE_PIT_TYPE.get());
        ...
        Ingredient earthBlocks = Ingredient.of(ItemTags.create(new ResourceLocation(materia.MOD_ID, "earth_blocks")));
