...
public class SackMenu extends AbstractContainerMenu {
    ...
    public SackMenu(int containerId, Inventory inv, InteractionHand hand) {
        ...
        this.handler = this.sackStack.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY)
    ...
    public boolean stillValid(Player player) {
        ...
        return !inHand.isEmpty() && ItemStack.isSameItemSameTags(inHand, this.sackStack);
    }
