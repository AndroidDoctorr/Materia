 ...
 * top 6×6 caps at (0,0), sides 6×7 at (0,6). Scaled to 67% via baked dimensions.
 */
public class CartLanternModel extends EntityModel<CartEntity> {
    ...
    private static final float LANTERN_W = 6.0F * LANTERN_SCALE;
    private static final float LANTERN_H = 7.0F * LANTERN_SCALE;
    private static final float LANTERN_D = 6.0F * LANTERN_SCALE;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        lantern.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .addBox(-HALF_LANTERN_W, 0.0F, -HALF_LANTERN_D, LANTERN_W, LANTERN_H, SHELL),
                PartPose.ZERO);
        lantern.addOrReplaceChild(
                "face_south",
                CubeListBuilder.create()
                        .texOffs(SIDE_U, SIDE_V)
                        .addBox(-HALF_LANTERN_W, 0.0F, HALF_LANTERN_D - SHELL, LANTERN_W, LANTERN_H, SHELL),
                PartPose.ZERO);
        lantern.addOrReplaceChild(
                "face_west",
                CubeListBuilder.create()
                        .texOffs(SIDE_U, 0)
                        .addBox(-HALF_LANTERN_W, 0.0F, -HALF_LANTERN_D, SHELL, LANTERN_H, LANTERN_D),
                PartPose.ZERO);
        lantern.addOrReplaceChild(
                "face_east",
                CubeListBuilder.create()
                        .texOffs(SIDE_U, 0)
                        .addBox(HALF_LANTERN_W - SHELL, 0.0F, -HALF_LANTERN_D, SHELL, LANTERN_H, LANTERN_D),
                PartPose.ZERO);
        lantern.addOrReplaceChild(
                "face_up",
                CubeListBuilder.create()
                        .texOffs(CAP_U, CAP_V)
                        .addBox(-HALF_LANTERN_W, LANTERN_H - SHELL, -HALF_LANTERN_D, LANTERN_W, SHELL, LANTERN_D),
                PartPose.ZERO);
        lantern.addOrReplaceChild(
                "face_down",
                CubeListBuilder.create()
                        .texOffs(CAP_U, CAP_V)
                        .addBox(-HALF_LANTERN_W, 0.0F, -HALF_LANTERN_D, LANTERN_W, SHELL, LANTERN_D),
                PartPose.ZERO);
