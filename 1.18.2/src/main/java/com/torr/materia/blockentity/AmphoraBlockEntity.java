...
public class AmphoraBlockEntity extends BaseContainerBlockEntity implements WorldlyContainer {
            ...
            if (this.hasWater()) {
                ...
                switch (liquidType) {
                    ...
                    case "grape_juice":
                        ...
                        break;
                    case "milk":
                        expectedType = com.torr.materia.AmphoraBlock.LiquidType.MILK;
                        break;
                    case "beer_mash":
                        expectedType = com.torr.materia.AmphoraBlock.LiquidType.BEER_MASH;
                        break;
                    case "beer":
    ...
    public net.minecraft.network.chat.Component getMashStatusMessage() {
        if (this.hasBeerMash()) {
            return new net.minecraft.network.chat.TranslatableComponent(
                    ...
                    this.isBeerMashComplete()
                            ? new net.minecraft.network.chat.TranslatableComponent("message.materia.amphora.beer_mash_complete")
                            : new net.minecraft.network.chat.TextComponent("")
            );
        }
        if (this.hasWater()) {
            return new net.minecraft.network.chat.TranslatableComponent("message.materia.amphora.beer_mash_hint");
        }
        return new net.minecraft.network.chat.TranslatableComponent("message.materia.amphora.beer_mash_need_water");
    }
    ...
    public boolean tryAddBeerMashIngredient(ItemStack ingredient) {
        ...
        // Convert water -> beer mash on first ingredient
        if (this.hasWater()) {
