...
public class AdvancedKilnRecipe implements Recipe<Container> {
    ...
    public RecipeType<?> getType() {
        return ModRecipes.ADVANCED_KILN_TYPE;
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<AdvancedKilnRecipe> {
        @Override
