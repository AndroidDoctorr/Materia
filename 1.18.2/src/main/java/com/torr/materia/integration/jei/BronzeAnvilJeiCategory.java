...
public class BronzeAnvilJeiCategory implements IRecipeCategory<BronzeAnvilRecipe> {
    private static final ResourceLocation UID = new ResourceLocation(materia.MOD_ID, "bronze_anvil");
    ...
    @Override
    public Class<? extends BronzeAnvilRecipe> getRecipeClass() {
        return BronzeAnvilRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.materia.bronze_anvil");
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, BronzeAnvilRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 60, 34)
