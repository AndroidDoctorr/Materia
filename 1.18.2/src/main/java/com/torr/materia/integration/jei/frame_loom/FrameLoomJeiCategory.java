...
public class FrameLoomJeiCategory implements IRecipeCategory<FrameLoomJeiRecipe> {
    private static final ResourceLocation UID = new ResourceLocation(materia.MOD_ID, "frame_loom");
    ...
    @Override
    public Class<? extends FrameLoomJeiRecipe> getRecipeClass() {
        return FrameLoomJeiRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.materia.frame_loom");
    }
