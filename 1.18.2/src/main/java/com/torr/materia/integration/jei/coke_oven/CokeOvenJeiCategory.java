...
public class CokeOvenJeiCategory implements IRecipeCategory<CokeOvenJeiRecipe> {
    private static final ResourceLocation UID = new ResourceLocation(materia.MOD_ID, "coke_oven");
    ...
    @Override
    public Class<? extends CokeOvenJeiRecipe> getRecipeClass() {
        return CokeOvenJeiRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.materia.coke_oven");
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, CokeOvenJeiRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 18, 32)
                ...
                .addTooltipCallback((recipeSlotView, tooltip) ->
                        tooltip.add(new TranslatableComponent("jei.materia.coke_oven.fuel_slot")));
