...
public class DryingRackJeiCategory implements IRecipeCategory<DryingRackJeiRecipe> {
    private static final ResourceLocation UID = new ResourceLocation(materia.MOD_ID, "drying_rack");
    ...
    @Override
    public Class<? extends DryingRackJeiRecipe> getRecipeClass() {
        return DryingRackJeiRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.materia.drying_rack");
    }
