...
public class FirePitJeiCategory implements IRecipeCategory<FirePitRecipe> {
    ...
    private static final ResourceLocation UID = new ResourceLocation(materia.MOD_ID, "fire_pit");
    ...
    public Component getTitle() {
        return new TranslatableComponent("jei.materia.fire_pit");
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, FirePitRecipe recipe, IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.INPUT, 18, 32)
                ...
                .addTooltipCallback((view, tooltip) -> {
                    ...
                    tooltip.add(new TranslatableComponent("jei.materia.fire_pit.duration_ticks", secs, ticks));
                });
