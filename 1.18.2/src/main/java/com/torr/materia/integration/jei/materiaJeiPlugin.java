...
public class materiaJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        // Core custom recipe types
        List<KilnRecipe> kiln = recipeManager.getAllRecipesFor(ModRecipes.KILN_TYPE);
        List<AdvancedKilnRecipe> advancedKiln = recipeManager.getAllRecipesFor(ModRecipes.ADVANCED_KILN_TYPE);
        List<OvenRecipe> oven = recipeManager.getAllRecipesFor(ModRecipes.OVEN_TYPE);
        List<StoneAnvilRecipe> stoneAnvil = recipeManager.getAllRecipesFor(ModRecipes.STONE_ANVIL_TYPE);
        List<BronzeAnvilRecipe> bronzeAnvil = recipeManager.getAllRecipesFor(ModRecipes.BRONZE_ANVIL_TYPE);
        List<IronAnvilRecipe> ironAnvil = recipeManager.getAllRecipesFor(ModRecipes.IRON_ANVIL_TYPE);

        List<FirePitRecipe> firePit = recipeManager.getAllRecipesFor(ModRecipes.FIRE_PIT_TYPE);
        registration.addRecipes(materiaJeiRecipeTypes.FIRE_PIT, firePit);
        ...
        List<WaterPotRecipe> waterPotRecipes = recipeManager.getAllRecipesFor(ModRecipes.WATER_POT_TYPE);
    ...
    private void registerMetalworkingJeiTips(IRecipeRegistration registration) {
        registration.addIngredientInfo(
                ...
                new TextComponent("Metalworking tip: anvil inputs must be hot."),
                new TextComponent("Creative/testing: use /heatmetal on the held item."),
                new TextComponent("Some recipes consume multiple units (for example, 9 ingots -> 1 metal block).")
        );
        ...
        registration.addIngredientInfo(
                ...
                VanillaTypes.ITEM_STACK,
                new TextComponent("Bronze alloy: 1x raw copper + 1x tin nugget.")
        );
        ...
        registration.addIngredientInfo(
                ...
                VanillaTypes.ITEM_STACK,
                new TextComponent("Brass alloy: 2x raw copper + 1x raw zinc.")
        );
    }
    ...
    private void registerPlantJeiTips(IRecipeRegistration registration) {
        registration.addIngredientInfo(
                ...
                VanillaTypes.ITEM_STACK,
                new TranslatableComponent("jei.materia.rice")
        );
        ...
        registration.addIngredientInfo(
                ...
                VanillaTypes.ITEM_STACK,
                new TranslatableComponent("jei.materia.cotton")
        );
        ...
        registration.addIngredientInfo(
                ...
                VanillaTypes.ITEM_STACK,
                new TranslatableComponent("jei.materia.tea_bush")
        );
        ...
        registration.addIngredientInfo(
                ...
                VanillaTypes.ITEM_STACK,
                new TranslatableComponent("jei.materia.taro")
        );

        registration.addIngredientInfo(
                List.of(new ItemStack(ModBlocks.SPINNING_WHEEL.get())),
                VanillaTypes.ITEM_STACK,
                new TranslatableComponent("jei.materia.spinning_wheel")
        );
    }
}
