    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (stack.hasTag() && stack.getTag().contains("BlockEntityTag")) {
            ...
            if (storageMode == AmphoraBlockEntity.MODE_LIQUID) {
                ...
                if (blockEntityTag.contains("LiquidAmount") && blockEntityTag.contains("LiquidType")) {
                    ...
                    if (liquidAmount > 0) {
                        ...
                        tooltip.add(new net.minecraft.network.chat.TextComponent("§9Contains: " + liquidAmount + " bottles of " + liquidName));
                    }
                }
                ...
                if (blockEntityTag.contains("Items", 9)) { // 9 = ListTag type
                    ...
                    if (itemCount > 0) {
                        tooltip.add(new net.minecraft.network.chat.TextComponent("§6Contains: " + itemCount + " items"));
                    }
                }
            }
            ...
            if (blockEntityTag.contains("HasLid") && blockEntityTag.getBoolean("HasLid")) {
                ...
                tooltip.add(new net.minecraft.network.chat.TextComponent("§7Has " + lidType));
            }
            ...
            if (blockEntityTag.contains("IsFermenting") && blockEntityTag.getBoolean("IsFermenting")) {
                ...
                tooltip.add(new net.minecraft.network.chat.TextComponent("§5Fermenting to " + product + ": " + String.format("%.1f", percent) + "%"));
            }
        }
    }
}
